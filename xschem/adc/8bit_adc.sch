...
C {devices/lab_pin.sym} -350 -220 0 0 {name=p2 lab=VDD}
C {devices/lab_pin.sym} -220 -130 2 0 {name=p3 lab=VDD}
C {devices/lab_pin.sym} -90 -220 0 0 {name=p4 lab=VDD}
C {devices/lab_pin.sym} 240 -170 2 0 {name=p5 lab=VDD}
C {devices/ipin.sym} 320 -360 0 0 {name=x1 lab=GND}
C {devices/lab_pin.sym} 230 390 2 0 {name=l2 sig_type=std_logic lab=GND}
